---
policy_id: POL-TPR-003
title: "Gestão de Subprocessadores"
version: 0.1.0
status: draft
classification: internal
owner: privacy-data-protection-agent
approver: founder
...
# POL-TPR-003 — Gestão de Subprocessadores

## 1. Objetivo

Controlar subprocessadores que tratem dados ou suportem serviços críticos.
...
- **POL-TPR-003-C01:** Manter lista, finalidade, localização e dados envolvidos.
- **POL-TPR-003-C02:** Avaliar transferência e requisitos contratuais.
- **POL-TPR-003-C03:** Exigir comunicação de mudanças relevantes.
- **POL-TPR-003-C04:** Revogar acesso e confirmar descarte no encerramento.

## 5. Papéis

- **Owner:** `privacy-data-protection-agent` — mantém a política e supervisiona a implementação.
