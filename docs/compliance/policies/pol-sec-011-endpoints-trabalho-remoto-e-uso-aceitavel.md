---
policy_id: POL-SEC-011
title: "Endpoints, Trabalho Remoto e Uso Aceitável"
version: 0.1.0
status: draft
...
# POL-SEC-011 — Endpoints, Trabalho Remoto e Uso Aceitável

## 1. Objetivo

Reduzir riscos associados a dispositivos, acesso remoto e uso de recursos PHYLLOS.
...
- **POL-SEC-011-C01:** Proteger dispositivos com autenticação e atualização.
- **POL-SEC-011-C02:** Evitar armazenamento local desnecessário de informação restrita.
- **POL-SEC-011-C03:** Usar canais autorizados para compartilhamento.
- **POL-SEC-011-C04:** Comunicar perda, roubo ou suspeita de comprometimento.
