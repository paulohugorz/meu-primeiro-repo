...
# POL-SEC-003 — Identidade e Controle de Acesso

## 1. Objetivo

Garantir acesso autorizado, individual, rastreável e proporcional às funções.
...
- **POL-SEC-003-C01:** Proibir contas compartilhadas para atividades privilegiadas.
- **POL-SEC-003-C02:** Exigir MFA para acessos administrativos quando suportado.
- **POL-SEC-003-C03:** Revisar acessos periodicamente e após desligamentos.
- **POL-SEC-003-C04:** Aplicar menor privilégio e negar por padrão.
