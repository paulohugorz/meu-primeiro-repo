...
# POL-PRV-001 — Privacidade e Proteção de Dados Pessoais

## 1. Objetivo

Assegurar tratamento legítimo, necessário, transparente e seguro de dados pessoais.

## 2. Escopo

Aplica-se às pessoas, agentes, sistemas, dados, integrações e terceiros da PHYLLOS relacionados ao domínio **Privacidade**. Exclusões devem ser documentadas no Statement of Applicability e aprovadas conforme risco.
...
- **POL-PRV-001-C01:** Manter inventário de tratamento, finalidade e base legal.
- **POL-PRV-001-C02:** Aplicar minimização, acesso restrito e transparência.
- **POL-PRV-001-C03:** Atender direitos dos titulares com registro.
- **POL-PRV-001-C04:** Avaliar incidentes e obrigações de comunicação.
