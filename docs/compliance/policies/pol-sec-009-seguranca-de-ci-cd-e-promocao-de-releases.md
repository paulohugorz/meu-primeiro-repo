---
policy_id: POL-SEC-009
title: "Segurança de CI/CD e Promoção de Releases"
version: 0.1.0
status: draft
...
# POL-SEC-009 — Segurança de CI/CD e Promoção de Releases

## 1. Objetivo

Proteger pipelines, artefatos, aprovações e promoção entre ambientes.
...
- **POL-SEC-009-C01:** Restringir alteração de pipelines e secrets.
- **POL-SEC-009-C02:** Executar verificações automatizadas aplicáveis.
- **POL-SEC-009-C03:** Preservar proveniência do artefato promovido.
- **POL-SEC-009-C04:** Bloquear release com falha crítica não aceita.
