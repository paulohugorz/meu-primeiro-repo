...
# POL-SEC-010 — Resposta a Incidentes de Segurança

## 1. Objetivo

Detectar, conter, investigar, comunicar e aprender com incidentes de segurança.
...
- **POL-SEC-010-C01:** Manter critérios de severidade e escalonamento.
- **POL-SEC-010-C02:** Preservar evidências e cadeia de custódia.
- **POL-SEC-010-C03:** Avaliar obrigações de notificação.
- **POL-SEC-010-C04:** Executar retrospectiva e CAPA.
