---
policy_id: POL-MET-001
title: "Gestão de Métodos, Fórmulas, Datasets e Prompts"
version: 0.1.0
status: draft
...
# POL-MET-001 — Gestão de Métodos, Fórmulas, Datasets e Prompts

## 1. Objetivo

Preservar reprodutibilidade, revisão e limites dos métodos PHYLLOS.

## 2. Escopo

Aplica-se às pessoas, agentes, sistemas, dados, integrações e terceiros da PHYLLOS relacionados ao domínio **Métodos**. Exclusões devem ser documentadas no Statement of Applicability e aprovadas conforme risco.
...
- **POL-MET-001-C01:** Registrar fonte, versão, unidade, transformação e arredondamento.
- **POL-MET-001-C02:** Documentar hipóteses, incerteza e limites de validade.
- **POL-MET-001-C03:** Versionar datasets, prompts, regras e parâmetros.
- **POL-MET-001-C04:** Proibir promoção de estimativa experimental como fato verificado.
