...
title: "Sistema de Compliance e Gestão de Riscos"
version: 0.1.0
status: draft
classification: internal
owner: chief-compliance-risk-officer
approver: founder
...
# POL-GOV-001 — Sistema de Compliance e Gestão de Riscos

## 1. Objetivo

Estabelecer o sistema de compliance, riscos, controles, exceções e reporte executivo.

## 2. Escopo

Aplica-se às pessoas, agentes, sistemas, dados, integrações e terceiros da PHYLLOS relacionados ao domínio **Governança**. Exclusões devem ser documentadas no Statement of Applicability e aprovadas conforme risco.
...
- **POL-GOV-001-C01:** Manter registro de obrigações, riscos e controles com owners definidos.
- **POL-GOV-001-C02:** Executar management review trimestral.
- **POL-GOV-001-C03:** Documentar aceitação de riscos materiais pelo founder.
- **POL-GOV-001-C04:** Manter indicadores, achados e CAPAs rastreáveis.

## 5. Papéis

- **Owner:** `chief-compliance-risk-officer` — mantém a política e supervisiona a implementação.
