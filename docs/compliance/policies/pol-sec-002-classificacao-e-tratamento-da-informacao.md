...
title: "Classificação e Tratamento da Informação"
version: 0.1.0
status: draft
...
# POL-SEC-002 — Classificação e Tratamento da Informação

## 1. Objetivo

Classificar informação e definir controles de armazenamento, transmissão, acesso e descarte.
...
- **POL-SEC-002-C01:** Usar classes Pública, Interna, Confidencial e Restrita.
- **POL-SEC-002-C02:** Aplicar menor privilégio e necessidade de conhecimento.
- **POL-SEC-002-C03:** Proteger exportações e compartilhamentos externos.
- **POL-SEC-002-C04:** Registrar descarte seguro e retenção aplicável.
