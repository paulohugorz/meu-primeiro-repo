---
policy_id: POL-EVD-001
title: "Evidências, Registros e Cadeia de Custódia"
version: 0.1.0
status: draft
classification: internal
owner: evidence-records-governance-agent
approver: founder
...
# POL-EVD-001 — Evidências, Registros e Cadeia de Custódia

## 1. Objetivo

Garantir integridade, localização, autorização e rastreabilidade das evidências.

## 2. Escopo

Aplica-se às pessoas, agentes, sistemas, dados, integrações e terceiros da PHYLLOS relacionados ao domínio **Evidências**. Exclusões devem ser documentadas no Statement of Applicability e aprovadas conforme risco.
...
- **POL-EVD-001-C01:** Registrar origem, autor, data, versão, hash e vínculo.
- **POL-EVD-001-C02:** Preservar histórico append-only para evidência oficial.
- **POL-EVD-001-C03:** Controlar acesso, retenção e exportação.
- **POL-EVD-001-C04:** Distinguir documento original, derivado, inferência e relatório.

## 5. Papéis

- **Owner:** `evidence-records-governance-agent` — mantém a política e supervisiona a implementação.
