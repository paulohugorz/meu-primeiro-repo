...
title: "Validação, Monitoramento, Drift e Rollback"
version: 0.1.0
status: draft
...
# POL-AI-002 — Validação, Monitoramento, Drift e Rollback

## 1. Objetivo

Garantir que sistemas de IA permaneçam dentro dos limites avaliados.
...
- **POL-AI-002-C01:** Definir métricas, baseline e limiares.
- **POL-AI-002-C02:** Monitorar qualidade, drift, segurança e falhas.
- **POL-AI-002-C03:** Registrar versões, datasets e resultados.
- **POL-AI-002-C04:** Executar rollback ou suspensão quando critérios forem violados.
