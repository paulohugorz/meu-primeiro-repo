...
# POL-BCP-002 — Continuidade de Negócios

## 1. Objetivo

Manter operações essenciais durante interrupções relevantes.

## 2. Escopo

Aplica-se às pessoas, agentes, sistemas, dados, integrações e terceiros da PHYLLOS relacionados ao domínio **Continuidade**. Exclusões devem ser documentadas no Statement of Applicability e aprovadas conforme risco.
...
- **POL-BCP-002-C01:** Identificar processos e dependências críticas.
- **POL-BCP-002-C02:** Definir estratégia, responsáveis e comunicação.
- **POL-BCP-002-C03:** Realizar exercícios periódicos.
- **POL-BCP-002-C04:** Atualizar planos após incidentes ou mudanças materiais.
