---
policy_id: POL-TPR-002
title: "Due Diligence e Contratação de Fornecedores"
version: 0.1.0
status: draft
classification: internal
owner: third-party-risk-agent
approver: founder
...
# POL-TPR-002 — Due Diligence e Contratação de Fornecedores

## 1. Objetivo

Incorporar requisitos de segurança, privacidade, evidência e continuidade à contratação.

## 2. Escopo

Aplica-se às pessoas, agentes, sistemas, dados, integrações e terceiros da PHYLLOS relacionados ao domínio **Terceiros**. Exclusões devem ser documentadas no Statement of Applicability e aprovadas conforme risco.
...
- **POL-TPR-002-C01:** Avaliar capacidade, histórico e controles do fornecedor.
- **POL-TPR-002-C02:** Definir cláusulas mínimas, notificações e direito de auditoria quando aplicável.
- **POL-TPR-002-C03:** Aprovar exceções antes da contratação.
- **POL-TPR-002-C04:** Reavaliar mudanças materiais no serviço.

## 5. Papéis

- **Owner:** `third-party-risk-agent` — mantém a política e supervisiona a implementação.
