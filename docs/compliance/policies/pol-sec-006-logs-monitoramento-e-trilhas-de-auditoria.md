---
policy_id: POL-SEC-006
title: "Logs, Monitoramento e Trilhas de Auditoria"
version: 0.1.0
status: draft
...
# POL-SEC-006 — Logs, Monitoramento e Trilhas de Auditoria

## 1. Objetivo

Assegurar detecção, investigação, responsabilização e reconstrução de eventos.
...
- **POL-SEC-006-C01:** Registrar autenticação, autorização, alterações e publicações críticas.
- **POL-SEC-006-C02:** Sincronizar tempo e preservar integridade dos logs.
- **POL-SEC-006-C03:** Definir retenção por criticidade e obrigação.
- **POL-SEC-006-C04:** Alertas críticos devem gerar incidente rastreável.
