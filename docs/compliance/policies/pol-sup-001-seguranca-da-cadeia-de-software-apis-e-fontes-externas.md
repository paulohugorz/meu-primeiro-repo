...
title: "Segurança da Cadeia de Software, APIs e Fontes Externas"
version: 0.1.0
status: draft
...
# POL-SUP-001 — Segurança da Cadeia de Software, APIs e Fontes Externas

## 1. Objetivo

Controlar dependências, APIs, bibliotecas, fontes de dados e artefatos externos.
...
- **POL-SUP-001-C01:** Registrar origem, versão, licença e criticidade.
- **POL-SUP-001-C02:** Verificar integridade e vulnerabilidades.
- **POL-SUP-001-C03:** Validar fontes antes de uso em claims ou modelos.
- **POL-SUP-001-C04:** Manter alternativa ou plano de saída para dependências críticas.
