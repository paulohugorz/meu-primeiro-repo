...
title: "Vulnerabilidades, Patches e Dependências"
version: 0.1.0
status: draft
...
# POL-SEC-007 — Vulnerabilidades, Patches e Dependências

## 1. Objetivo

Identificar, priorizar e corrigir vulnerabilidades em código, infraestrutura e dependências.
...
- **POL-SEC-007-C01:** Manter inventário de componentes e versões.
- **POL-SEC-007-C02:** Classificar vulnerabilidades por exposição e impacto.
- **POL-SEC-007-C03:** Definir SLA de correção por severidade.
- **POL-SEC-007-C04:** Registrar exceções e controles compensatórios.
