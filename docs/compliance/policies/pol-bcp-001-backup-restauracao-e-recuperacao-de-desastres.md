...
title: "Backup, Restauração e Recuperação de Desastres"
version: 0.1.0
status: draft
...
# POL-BCP-001 — Backup, Restauração e Recuperação de Desastres

## 1. Objetivo

Proteger a recuperação de dados, configurações e serviços críticos.
...
- **POL-BCP-001-C01:** Definir RPO e RTO por serviço.
- **POL-BCP-001-C02:** Testar restauração em periodicidade baseada em risco.
- **POL-BCP-001-C03:** Separar cópias de falhas do ambiente primário.
- **POL-BCP-001-C04:** Registrar resultados e correções dos testes.
